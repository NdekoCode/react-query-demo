...
[API routes](https://nextjs.org/docs/api-routes/introduction) can be accessed on [http://localhost:3000/api/route](http://localhost:3000/api/route). This endpoint can be edited in `app/api/route.ts`.
